...
@st.cache
def load_hospitals():
    df_hospital_2 = pd.read_csv(r"C:/Users/Brian/Desktop/AHI_STATS_507/Week13_Summary/df_hospital_2.csv")
    return df_hospital_2

@st.cache
def load_inatpatient():
    df_inpatient_2 = pd.read_csv(r"C:/Users/Brian/Desktop/AHI_STATS_507/Week13_Summary/df_inpatient_2.csv")
    return df_inpatient_2

@st.cache
def load_outpatient():
    df_outpatient_2 = pd.read_csv(r"C:\Users\Brian\Desktop\AHI_STATS_507\Week13_Summary\df_outpatient_2.csv")
